...
- Fork and clone this reposoitory
- Complete the exercises included in main.js

## Deliverable

- This lab is a **DELIVERABLE**.
- Create a pull request to submit your complete/in-progress lab
...
When your js file is run, the console should show the following:
